...
ฉันเห็นว่า timeframe day และ week มีราคาเปิดที่แตกต่างกัน คุณช่วย ดึงราคาเปิดของส่วน week ให้หน่อยได้ไหมโดยเพิ่มคอลั่ม open_weekly ที่ตาราง rating_history และช่วยเพิ่มคอลั่ม open_weekly และคอลั่ม openweekly_pre ในตาราง rating_accuracy ด้วย โดยการทำงานให้ทำงานเหลือนกับในส่วนของ daily เลย และ ช่วยเปลี่ยนการแสดงผลใน frontend ในส่วน 